		...
		<div className="container">
			<div className="row">
				<div className="col s-8 m-6 s-offset-2 m-offset-3">
					...
					<p className="desc">
						Это инструмент по поиску ответов на свои вопросы. И не важно в какой сфере
						жизни они лежат - личное развитие или отношения, творчество или открытие
						бизнеса, карьера или деньги, планирование или разработка новой идеи, поиск
						смысла или просто научиться принимать мир как он есть.
					</p>
				</div>
			</div>
		</div>
